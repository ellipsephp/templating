...
class TemplateServiceProvider extends AbstractServiceProvider
{
    ...
    public function boot()
    {
        if ($this->shouldregisterEngine(static::KEY_PLATES)) {
            ...
            EngineFactory::register(static::KEY_PLATES, $this->config, function ($view_dir, $options) {
        ...
        if ($this->shouldregisterEngine(static::KEY_TWIG)) {
            ...
            EngineFactory::register(static::KEY_TWIG, $this->config, function ($view_dir, $options) {
